...
public class Main {
	...
	public static void main(String[] args) {
		...
		/* Часть кода, реализуящая решение домашней задачи номер 5 пункт 3 и 4 */
		System.out.print("\nСохраним группу студентов в текстовый файл: ");
		newGroup.groupToTextFile("C:/JAVA/students_group.txt");

		String fileWithStudentsPath = "C:/JAVA/students_group";

		System.out.print("\nСохраним группу студентов в файл (сериализация массива студентов): ");
		newGroup.serializeGroupToFile(fileWithStudentsPath);

		System.out.print("\nВыгрузим группу студентов из файла (де-сериализация массива студентов): ");
		newGroup.deSerializeGroupFromFile(fileWithStudentsPath);
		 ...
		 * 
		 * System.out.println("Найти студентов с фамилией " + studentSurname + ":"); for
		 * (Student foundStudent : newGroup.getStudentsBySurname(studentSurname)) {
